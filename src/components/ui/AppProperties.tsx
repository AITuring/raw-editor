...
export enum Invokes {
  ...
  AnalyzeBatchGeometry = 'analyze_batch_geometry',
  BatchGeometryCorrection = 'batch_geometry_correction',
  ...
  ExportStyleTransfer = 'export_style_transfer',
  ...
  GenerateStyleTransferPreview = 'generate_style_transfer_preview',
  ...
  ImportWatermarkImage = 'import_watermark_image',
  ...
  PreviewBatchGeometryCorrection = 'preview_batch_geometry_correction',
